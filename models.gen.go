// Package loki_api provides primitives to interact with the openapi HTTP API.
//
...
// APIKey API Key to interact with Loki Cloud under specific team
type APIKey struct {
...
type Addon struct {
	...
	// Official True if the addon is maintained by Loki, false otherwise
	Official bool `json:"official"`

	// PriceUsd The price for 6 months
	PriceUSD string `json:"price_usd"`

	// Public Whether the plugin is listed in the Loki Hub. If false, the plugin will not be shown in the Loki Hub and will only be visible to members of the plugin's team.
...
// AddonVersion Loki Addon Version
...
type ListPlugin struct {
	...
	// Official True if the plugin is maintained by Loki, false otherwise
	Official bool `json:"official"`
...
type PluginCreate struct {
	...
	// DisplayName The plugin's display name, as shown in the Loki Hub.
	DisplayName string `json:"display_name"`
	...
	// Logo URL to the plugin's logo. This will be shown in the Loki Hub. This must point to https://images.loki.pixis.ai/...
	Logo string `json:"logo"`

	// Name The unique name for the plugin.
	Name PluginName `json:"name"`

	// Public Whether the plugin is listed in the Loki Hub. If false, the plugin will not be shown in the Loki Hub and will only be visible to members of the team.
	Public bool `json:"public"`
	...
	// ShortDescription Short description of the plugin. This will be shown in the Loki Hub.
	ShortDescription string `json:"short_description"`
...
// PluginDocsPage Loki Plugin Documentation Page
...
// PluginDocsPageCreate Loki Plugin Documentation Page
...
// PluginProtocols The Loki protocols supported by this plugin version (only protocol 3 is supported by new plugins).
...
// PluginTableColumn Loki Plugin Column
...
// PluginTableCreate Loki Plugin Table
...
type PluginUpdate struct {
	...
	// Public If plugin is not public, it won't be visible to other teams in the Loki Hub.
	Public *bool `json:"public,omitempty"`
...
// PluginVersion Loki Plugin Version
type PluginVersion struct {
	...
	// Protocols The Loki protocols supported by this plugin version (only protocol 3 is supported by new plugins).
